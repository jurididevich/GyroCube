...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 454.0, 739.0, 251.0, 35.0 ],
					"text" : ";\rmax opendoc jitter_gpu_instancing.maxvig.xml"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 8.0, 740.0, 67.0 ],
					"text" : "This example shows a way to use jit.gl.mesh for GPU instancing, similar to how you might normally use jit.gl.multiple. Note the instanced jit.gl.buffer going into the right inlet of jit.gl.mesh."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 116.5, 156.0, 60.0, 35.0 ]
				}
...
,
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "" ],
					"patching_rect" : [ 11.0, 117.0, 230.0, 22.0 ],
					"text" : "jit.world @fsaa 1 @high_res 1 @enable 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 170.5, 89.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 89.0, 150.0, 22.0 ]
				}
